    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6">
          <Link href="/medications/prescriptions" className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center mb-4">
              <FileText className="h-8 w-8 text-blue-600 mr-3" />
              <h3 className="text-xl font-semibold text-slate-800">Prescription Management</h3>
            </div>
            <p className="text-gray-600">Create, edit, and manage patient prescriptions</p>
          </Link>
