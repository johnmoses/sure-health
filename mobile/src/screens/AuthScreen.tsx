  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>SureHealth</Text>
        ...
        {!isLogin && (
          <View style={styles.roleContainer}>
            ...
            <View style={styles.roleButtons}>
              ...
              >
                <Text
                  style={[styles.roleButtonText, role === 'user' && styles.activeRoleButtonText]}
                >
                  User
                </Text>
              </TouchableOpacity>
              ...
              >
                <Text
                  style={[styles.roleButtonText, role === 'admin' && styles.activeRoleButtonText]}
                >
                  Admin
                </Text>
              </TouchableOpacity>
